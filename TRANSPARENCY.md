...
Coding assistance for this repository was provided by **Robbert Erdmann** (University
of Amsterdam, initial concept and code) and **Anthropic Claude Sonnet 4.6**
(code review, refinement and repository, June 2026).
...
- Interpret results nor draw scientific conclusions
- Collect nor process of the original image data
